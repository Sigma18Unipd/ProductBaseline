        ...
        <Dialog>
          ...
          <DialogContent>
            ...
            <div className='grid gap-2'>
              ...
              <Input type='text' placeholder='Enter your Bot token' defaultValue={data.botToken || 'TOKEN HERE'} />
            </div>
            <div className='grid gap-2'>
              <Label>Chat ID</Label>
              <Input type='text' placeholder='Enter your Chat ID' defaultValue={data.chatId || 'CHAT ID HERE'} />
            </div>
            <div className='grid gap-2'>
              <Label>Message</Label>
              <Input type='text' placeholder='Enter your message' defaultValue={data.message || 'MESSAGE HERE'} />
            </div>
            <DialogFooter>
              <DialogClose asChild>
                <Button>Save</Button>
